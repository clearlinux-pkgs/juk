...
Version  : 24.12.1
Release  : 56
URL      : https://download.kde.org/stable/release-service/24.12.1/src/juk-24.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/juk-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/juk-24.12.1.tar.xz.sig
...
%setup -q -n juk-24.12.1
cd %{_builddir}/juk-24.12.1
pushd ..
cp -a juk-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736534966
mkdir -p clr-build
pushd clr-build
