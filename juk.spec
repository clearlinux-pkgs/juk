...
Source0  : https://download.kde.org/stable/release-service/20.08.2/src/juk-20.08.2.tar.xz
...
%prep
%setup -q -n juk-20.08.2
cd %{_builddir}/juk-20.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602631720
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/juk-20.08.2/COPYING %{buildroot}/usr/share/package-licenses/juk/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/juk-20.08.2/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/juk/77976f406ba34009d9ba5a43b882fe6de68e5175
pushd clr-build
%make_install
popd
%find_lang juk
