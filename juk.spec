...
Source0  : https://download.kde.org/stable/release-service/21.08.3/src/juk-21.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.3/src/juk-21.08.3.tar.xz.sig
...
%prep
%setup -q -n juk-21.08.3
cd %{_builddir}/juk-21.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636062450
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/juk-21.08.3/COPYING %{buildroot}/usr/share/package-licenses/juk/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/juk-21.08.3/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/juk/77976f406ba34009d9ba5a43b882fe6de68e5175
pushd clr-build
%make_install
popd
%find_lang juk
