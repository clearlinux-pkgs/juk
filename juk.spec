...
Version  : 23.04.2
Release  : 32
URL      : https://download.kde.org/stable/release-service/23.04.2/src/juk-23.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/juk-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/juk-23.04.2.tar.xz.sig
...
%prep
%setup -q -n juk-23.04.2
cd %{_builddir}/juk-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686519423
mkdir -p clr-build
pushd clr-build
