...
Version  : 21.08.1
Release  : 8
URL      : https://download.kde.org/stable/release-service/21.08.1/src/juk-21.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.1/src/juk-21.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.1/src/juk-21.08.1.tar.xz.sig
...
%prep
%setup -q -n juk-21.08.1
cd %{_builddir}/juk-21.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630906713
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/juk-21.08.1/COPYING %{buildroot}/usr/share/package-licenses/juk/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/juk-21.08.1/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/juk/77976f406ba34009d9ba5a43b882fe6de68e5175
pushd clr-build
%make_install
popd
%find_lang juk
