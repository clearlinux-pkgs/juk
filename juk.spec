...
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/juk-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/juk-22.12.3.tar.xz.sig
...
%prep
%setup -q -n juk-22.12.3
cd %{_builddir}/juk-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677789153
mkdir -p clr-build
pushd clr-build
