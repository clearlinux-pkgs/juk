...
Version  : 24.08.0
Release  : 49
URL      : https://download.kde.org/stable/release-service/24.08.0/src/juk-24.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/juk-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/juk-24.08.0.tar.xz.sig
...
%setup -q -n juk-24.08.0
cd %{_builddir}/juk-24.08.0
pushd ..
cp -a juk-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724522545
mkdir -p clr-build
pushd clr-build
